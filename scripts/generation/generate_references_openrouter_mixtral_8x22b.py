#!/usr/bin/env python3
"""
Generate references from Mixtral 8x22B Instruct (39B active / 141B total MoE) via OpenRouter.
No-geography prompt (topic only). Temperature 0. Resume-safe.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python generate_references_openrouter_mixtral_8x22b.py
"""
...
MODEL_NAME = "mixtral_8x22b_141b_a39b"
