#!/usr/bin/env python3
"""
Generate references from Llama 4 Scout (17B active / 109B total, 16 experts MoE) via OpenRouter.
Same protocol, single model.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python generate_references_openrouter_llama4_scout.py
"""
...
MODEL_NAME = "llama_4_scout_109b_a17b"
