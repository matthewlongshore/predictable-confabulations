#!/usr/bin/env python3
"""
Generate references from Mistral Large 2 (123B dense) via OpenRouter.
Same protocol, single model.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python generate_references_openrouter_mistral_large2.py
"""
...
MODEL_NAME = "mistral_large_2_123b"
