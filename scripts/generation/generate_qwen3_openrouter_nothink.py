#!/usr/bin/env python3
"""
Generate references from Qwen3 dense family (4B, 8B, 14B) via OpenRouter.
Thinking OFF (/no_think). No-geography prompt. Temperature 0. Resume-safe.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python3 scripts/generate_qwen3_openrouter_nothink.py
"""
...
def run_model(model_id, model_name):
    full_name = f"{model_name}_nothink"
    ...
    print(f"\n{'='*60}")
    print(f"  Model: {model_id} (NO THINKING)")
...
def main():
    print("Qwen3 Dense Family — NO THINKING (nogeo protocol, OpenRouter)")
    print(f"Models: 4B, 8B, 14B\n")
