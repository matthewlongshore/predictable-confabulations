#!/usr/bin/env python3
"""
Generate references from Kimi K2 Thinking (32B active / 1T total MoE) via OpenRouter.
Same protocol, single model.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python generate_references_openrouter_kimi.py
"""
