#!/usr/bin/env python3
"""
Generate references from Mixtral 8x7B Instruct (13B active / 47B total MoE) via OpenRouter.
No-geography prompt (topic only). Temperature 0. Resume-safe.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python generate_references_openrouter_mixtral_8x7b.py
"""
...
MODEL_NAME = "mixtral_8x7b_47b_a13b"
