#!/usr/bin/env python3
"""
Generate references from DeepSeek V3 (37B active / 671B total MoE) via DeepInfra.
No-geography prompt (topic only). Temperature 0. Resume-safe.

Same active/total params as DeepSeek R1 but WITHOUT reasoning.

Usage:
    export DEEPINFRA_API_KEY=your_key_here
    python generate_references_deepinfra_deepseek_v3.py
"""
