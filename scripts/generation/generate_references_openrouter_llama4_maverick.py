#!/usr/bin/env python3
"""
Generate references from Llama 4 Maverick (17B active / 400B total, 128 experts MoE) via OpenRouter.
Same protocol, single model.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python generate_references_openrouter_llama4_maverick.py
"""
...
MODEL_NAME = "llama_4_maverick_400b_a17b"
