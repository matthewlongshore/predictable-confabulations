#!/usr/bin/env python3
"""
Generate references from DeepSeek V3 (37B active / 671B total MoE) via OpenRouter.
No-geography prompt (topic only). Temperature 0. Resume-safe.

Same active/total params as DeepSeek R1 but WITHOUT reasoning — isolates CoT effect.

Usage:
    export OPENROUTER_API_KEY=your_key_here
    python generate_references_openrouter_deepseek_v3.py
"""
...
MODEL_NAME = "deepseek_v3_671b_a37b"
